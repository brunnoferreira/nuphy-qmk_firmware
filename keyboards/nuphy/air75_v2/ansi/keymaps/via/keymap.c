...
[0] = LAYOUT_ansi_84(
	...
	KC_LCTL,	KC_LALT,	KC_LGUI,										KC_SPC, 							KC_RGUI,	KC_RALT,   	TD(OSL_1_5),			KC_LEFT,	KC_DOWN,    KC_RGHT),
...
[5] = LAYOUT_ansi_84(
	...
	_______,	_______,   	_______,   	_______,  	_______,   	_______,   	_______,	_______,   	_______,   	_______,  	_______,	_______, 	 						_______,	_______,
	_______,				_______,   	_______,   	_______,  	_______,   	_______,   	_______,	_______, 	_______,	_______,	_______,				_______,	_______,	_______,
	_______,	_______,	_______,										_______, 							_______,	_______,   	TD(OSL_1_5),			_______,	_______,    _______),
};
